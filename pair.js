...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    IMAGE_PATH: 'https://h.uguu.se/nXvmlMQU.jpg',
    GROUP_INVITE_LINK: '',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://h.uguu.se/nXvmlMQU.jpg',
    NEWSLETTER_JID: '120363415926731264@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    version: '1.0.0',
    OWNER_NUMBER: '2250143875869',
    BOT_FOOTER: '> ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴇɴᴋɪ',
...
╰───────────────❒
  > *▫️ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ ᴍᴀɪɴ*
  > ʀᴇsᴘᴏɴᴅ ᴛɪᴍᴇ: ${Date.now() - msg.messageTimestamp * 1000}ms
`;
        const aliveMessage = {
            image: { url: "https://h.uguu.se/nXvmlMQU.jpg" },
...
case 'menu': {
  try {
    ...
    let menuText = ` 
╭───────────────────❒
┃•│⬡ ʙᴏᴛ ɴᴀᴍᴇ : ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ
┃•│⬡ ᴠᴇʀsɪᴏɴ : 1.0.0
┃•│⬡ ᴜsᴇʀ : @${sender.split("@")[0]}
┃•│⬡ ᴘʀᴇғɪx : ${config.PREFIX}
┃•│⬡ ᴍᴇᴍᴏʀʏ : ${usedMemory}MB/${totalMemory}ᴍʙ
┃•│⬡ ᴅᴇᴠᴇʟᴏᴘᴇʀ : ᴅᴇɴᴋɪ ᴏғғɪᴄɪᴀʟ
╰────────────────────❒
...
`;
    ...
    const menuMessage = {
      image: { url: "https://h.uguu.se/nXvmlMQU.jpg" },
      caption: `*ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ*\n${menuText}`,
      buttons: [
        {
          buttonId: `${config.PREFIX}quick_commands`,
          buttonText: { displayText: 'ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: 'ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ ᴄᴍᴅs',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: 'ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ',
                  rows: [
  ...
  break;
            ...
            case 'fc': {
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.fcn 120363415926731264@newsletter'
                        });
                    }
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    if (!number) {
                        return await socket.sendMessage(sender, {
                            text: '*📌 ᴜsᴀɢᴇ:* .pair +225xxxxx'
                        }, { quoted: msg });
                    }

                    try {
                        const url = `https://denki-mini-bot.onrender.com/code?number=${encodeURIComponent(number)}`;
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
                ...
                case 'winfo': {
                    ...
                    if (!args[0]) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Please give me a phone number, darling! Usage: .winfo 2250143xxxxxxxx',
                                'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴇɴᴋɪ'
                            )
                        });
                        break;
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ. 
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://h.uguu.se/nXvmlMQU.jpg' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
...
//===============================
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
 ...
 // Case: add - Add a member to the group
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: 'https://h.uguu.se/nXvmlMQU.jpg' }, // Replace with your image URL
            caption: formatMessage(
                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
`;
        ...
        const repoMessage = {
            ...
            contextInfo: {
                ...
                isForwarded: true,
                forwardedNewsletterMessageInfo: {
                    newsletterJid: config.NEWSLETTER_JID || '120363415926731264@newsletter',
                    newsletterName: 'ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ',
                    serverMessageId: 143
                }
            }
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                mediaType: 1,
                mediaUrl: 'https://github.com/denki-arch/YOANN-XMD',
                sourceUrl: 'https://github.com/denki-arch/YOANN-XMD'
            }
        }
    }, { quoted: fakevCard });
    break;
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: `ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴅᴇɴᴋɪ ᴍɪɴɪ ʙᴏᴛ
╭─────────────────────❒
│✅ sᴜᴄᴄᴇssғᴜʟʟʏ ᴄᴏɴɴᴇᴄᴛᴇᴅ!
│🔢 ɴᴜᴍʙᴇʀ : ${sanitizedNumber}
│🏠 ɢʀᴏᴜᴘ sᴛᴀᴛᴜs : ${groupStatus}
│⏰ ᴄᴏɴɴᴇᴄᴛᴇᴅ : ${new Date().toLocaleString()}
│📡 ғᴏʟʟᴏᴡ ᴍʏ ᴄʜᴀɴɴᴇʟ : https://whatsapp.com/channel/0029VbB06qE9sBIFlu00Dq0R
